 ...
 * @author wenzhen
 * @Description
 * @Date: Created in 2019/10/25 17:01
 */
public class ExtConfigBuilder {
     ...
     * 注入配置信息
     */
    private ExtInjectionConfig extInjectionConfig;
    /**
     * 是否支持注释
     */
     ...
     */
    public ExtConfigBuilder(PackageConfig packageConfig, DataSourceConfig dataSourceConfig, StrategyConfig strategyConfig,
    ...
    public ExtConfigBuilder setTableInfoList(List<TableInfo> tableInfoList) {
    ...
    public ExtConfigBuilder setStrategyConfig(StrategyConfig strategyConfig) {
        this.strategyConfig = strategyConfig;
        return this;
    }
    ...
    public ExtConfigBuilder setGlobalConfig(GlobalConfig globalConfig) {
        this.globalConfig = globalConfig;
        return this;
    }


    public ExtInjectionConfig getExtInjectionConfig() {
        return extInjectionConfig;
    }


    public ExtConfigBuilder setExtInjectionConfig(ExtInjectionConfig extInjectionConfig) {
